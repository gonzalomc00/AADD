...
public class InfoUsuariosWeb implements Serializable {
    ...
    public void submit() {
        ...
        if(tipos == null || tipos.isEmpty()) {
            facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "Debe indicar los tipos de usuarios que deben recibir el mensaje", ""));
            return;
        }
        ...
        List<Integer> usuarios = ServicioGestionPlataforma.getServicioGestionPlataforma().getIdUsuariosByTipo(enumtipos);
