	...
	public void cerrarIncidencia() {
		if (servicioPlataforma.cerrarIncidencia(incidenciaSeleccionada, comentarioIncidencia)) {
			facesContext.addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_INFO, "La incidencia se ha cerrado correctamente", ""));
			loadIncidencias();
		} else {
			facesContext.addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "La incidencia no se ha cerrado correctamente", ""));
